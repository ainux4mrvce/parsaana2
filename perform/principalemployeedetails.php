...
<div class="container">
<form action="principal.php" ><input class="btn btn-primary btn-primary custom" type="submit" value="GO BACK"/></form>
</div>
