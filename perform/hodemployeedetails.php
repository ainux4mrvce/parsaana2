...
<div class="container">
<form action="hod.php" ><input class="btn btn-primary btn-primary custom" type="submit" value="GO BACK"/></form>
</div>

<form action="hodinsertdb.php" method="POST">
   <div class="container">
   <div class="row">
   <center>
