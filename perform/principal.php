...
<div class="container">
<form action="start.php" ><input class="btn btn-primary btn-primary custom" type="submit" value="SIGN OUT"/><br></form>
</div>
    ...
    $storeArray[] =  $row['name'];  
        ...
        // echo $ccc;
                   ...
                   
                 {
                   ...
                   echo '<tr><td><a href="principalemployeedetails.php?name='.$storeArray[$i].'">'.$storeArray[$i].'</a></td></tr>';
                 }
                   echo "</table>";
                   echo "</center></div></div>";
