...
xmlhttp.open("GET","earned_display.php",true);
xmlhttp.send();
}
</script>
...
xmlhttp.open("GET","history_display.php",true);
xmlhttp.send();
}
</script>
...
xmlhttp.open("GET","qualification_display.php",true);
xmlhttp.send();
}
</script>
...
xmlhttp.open("GET","service_display.php",true);
xmlhttp.send();
}
</script>
