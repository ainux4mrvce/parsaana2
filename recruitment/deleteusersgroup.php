...
<?php
$gname=$_POST['gname'];
if($result=$con->query("delete * from usersgroup where name='$gname'"))
{
  echo "<div class='container'>";
     echo "<div class='alert alert-success' id='successmsg'>
        <strong>Success!</strong> Group $gname Deleted Successfully!
     <br/>
...
else
{
   ...
   <strong>Error!</strong>Group $gname Not Deleted
   <a href='javascript:history.go(-1)'>&laquo;Go Back</a>
 </div>";
  echo "</div>";
}
